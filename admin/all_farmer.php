                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-outline-primary">
                                                <div class="card-header">
                                                    <h4 class="m-b-0 text-white">All Farmers</h4>
                                                </div>
                                    ...
                                    <?php
                        $sql="SELECT * FROM farmer order by f_id desc";
                        $query=mysqli_query($db,$sql);
                        
                            if(!mysqli_num_rows($query) > 0 )
                                {
                                    echo '<td colspan="11"><center>No Farmers</center></td>';
                                }
                            else
                                {				
                                            while($rows=mysqli_fetch_array($query))
                                                {
                                                        ...
                                                        $mql="SELECT * FROM p_category where c_id='".$rows['c_id']."'";
                                                            ...
                                                            echo ' <tr><td>'.$row['c_name'].'</td>
                                                                        ...
                                                                        <center><img src="prod_img/'.$rows['image'].'" class="img-responsive radius"  style="min-width:90px;min-height:70px;"/></center>
                                                                        </div></td>
                                                                        
                                                                        <td>'.$rows['date'].'</td>
                                                                                <td><a href="delete_farmer.php?res_del='.$rows['f_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                                                                <a href="update_farmer.php?res_upd='.$rows['f_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
                                                                            </td></tr>';
